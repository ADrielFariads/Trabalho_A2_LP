...
class Menu():
    ...
    def change_current_game_state(self, button, alow_heroe):
        ...
        button_actions = {
            ...
            self.easy_button: lambda: self.game_difficulty(1.2,1.2,1.3),
            self.medium_button: lambda: self.game_difficulty(1 ,1,1),
            self.hard_button: lambda: self.game_difficulty(0.7, 0.85,0.7)
    ...
    def game_difficulty(self, health_index, speed_index, enemy_index):
        self.reset_states()
